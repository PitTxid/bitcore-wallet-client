...
API.prototype.getFeeLevels = function(coin, network, cb) {
  ...
  $.checkArgument(coin || _.includes(['btc', 'bch', 'xsg', 'zec', 'dash', 'ltc'], coin));
...
API.prototype.createWallet = function(walletName, copayerName, m, n, opts, cb) {
  ...
  var coin = opts.coin || 'btc';
  if (!_.includes(['btc', 'bch', 'xsg', 'zec', 'dash', 'ltc'], coin)) return cb(new Error('Invalid coin'));
...
API.prototype.getBalance = function(opts, cb) {
  ...
  if (opts.coin) {
    if (!_.includes(['btc', 'bch', 'xsg', 'zec', 'dash', 'ltc'], opts.coin)) return cb(new Error('Invalid coin'));
...
API.signTxProposalFromAirGapped = function(key, txp, unencryptedPkr, m, n, opts) {
  ...
  var newClient = new API({
    baseUrl: 'http://192.168.1.100:3232/bws/api'
  });
